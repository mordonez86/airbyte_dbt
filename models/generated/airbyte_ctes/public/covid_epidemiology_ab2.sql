...
select
    ...
    cast(new_recovered as {{ dbt_utils.type_string() }}) as new_recovered,
    cast(total_deceased as {{ dbt_utils.type_string() }}) as total_deceased,
    cast(total_confirmed as {{ dbt_utils.type_string() }}) as total_confirmed,
    cast(total_recovered as {{ dbt_utils.type_string() }}) as total_recovered,
    _airbyte_ab_id,
    _airbyte_emitted_at,
